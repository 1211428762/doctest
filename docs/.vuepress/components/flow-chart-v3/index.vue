  ...
  <div class="v-flow-chat">
    <section class="VflowChat">
      ...
      <panelLeft
        ...
        v-model:MovePalette="MovePalette"
          ...
          >
            ...
            <template v-slot:node="{ meta }">
              <div @mouseup="nodeMouseUp" class="flow-node ellipsis">
                <icon-tag :icon="meta.icon"></icon-tag>
...
import superFlow from './indexProto.vue'
...
export default {
        ...
        open: (type, info) => {
          ...
          if (conf.type === drawerType.node) {
            ...
            Object.keys(this.nodeSetting).forEach((key) => {
              this.nodeSetting[key] = info.meta[key]
        ...
        [
          ...
          */
          ...
          // },
          {
            label: '打印数据',
            selected: (graph, coordinate) => {
              this.$emit('chart-data', JSON.stringify(graph.toJSON(), null, 2))
  ...
  watch: {
    MovePalette(val) {
      this.$refs.superFlow.changeMovePalette(val)
    },
  },
